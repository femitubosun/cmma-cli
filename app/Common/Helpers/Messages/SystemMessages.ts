...
export const EMAIL_EXPIRED_OTP = 'OTP Token Has Expired. Check your Email for new OTP Token'
export const INVALID_EMAIL_OTP = 'Invalid OTP Token. Check your email for a new OTP Token'
...
export const SEND_EMAIL_FAILED = 'Something went wrong while sending smail'
