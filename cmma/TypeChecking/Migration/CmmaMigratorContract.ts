 ...
 */
export class CmmaMigratorContract extends EventEmitter implements MigratorContract {
   ...
   */
  private migrationSource = new CmmaMigratorSource(this.config, this.app, this.cmmaConfig)
